...
import rutasCria from './rutas_cria.js';
import rutasInformes from './rutas_informes.js';
import rutasCosteo from './rutas_costeo.js';
import rutasTareas from './rutas_tareas.js';
import rutasCeba from './rutas_ceba.js';
...
// Módulo de granja de cría (todas sus rutas requieren sesión iniciada)
app.use('/api/cria', requiereLogin, rutasCria);
app.use('/api/informes', requiereLogin, rutasInformes);
app.use('/api/costeo', requiereLogin, rutasCosteo);
app.use('/api/tareas', requiereLogin, rutasTareas);
app.use('/api/ceba', requiereLogin, rutasCeba);
